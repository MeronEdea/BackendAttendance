# Generated by Django 4.1.13 on 2024-05-30 18:08
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('joinCode', models.CharField(default=None, max_length=10)),
            ],
        ),
        migrations.CreateModel(
            name='CustomUser',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('codename', models.CharField(default=None, max_length=100, unique=True)),
                ('name', models.CharField(default=None, max_length=100)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('face_encoding', models.FileField(upload_to='')),
                ('user', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='Attendance.customuser')),
            ],
        ),
        migrations.CreateModel(
        ...
        migrations.AddField(
            model_name='course',
            name='approved_teacher',
            field=models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='approved_courses', to='Attendance.teacher'),
        ),
        migrations.AddField(
            model_name='course',
            name='section',
            field=models.ManyToManyField(related_name='courses', to='Attendance.section'),
        ),
        migrations.CreateModel(
            name='Attendance',
            fields=[
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('permission', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='roles', to='Attendance.permission')),
                ('role', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='permissions', to='Attendance.role')),
            ],
            options={
